...
public class TsscGame implements Serializable {
	...
	@NotNull(groups= {generalValidator.class})
	@Positive(groups= {generalValidator.class})
	...
	@NotBlank(groups= {generalValidator.class})
	private String name;
	...
	@NotNull(groups= {generalValidator.class})
	@FutureOrPresent(groups= {generalValidator.class})
